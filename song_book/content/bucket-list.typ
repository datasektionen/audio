...
#box[
  #align(left, pad(left: -9pt, right: -20pt, bottom: -10pt)[
      ...
      #bucket-list-item[Skriv en egen sång #text(style: "italic")[(s.187)] och framför den på en gasque.]
      #bucket-list-item[Var först med att ropa "Hörde jag vikingen?" på en gasque.]
      #bucket-list-item[Starta “Vikingen” #text(style: "italic")[(s.16)] genom att svara ”Att du gjorde!” efter att någon annan gör ovanstående.]
      #bucket-list-item[Sjung varje sång i sångboken #text(style: "italic")[(s.0-198)].]
      ...
      #bucket-list-item[Kasta #text(style: "italic")[inte] ditt glas efter “Sista punschvisan” #text(style: "italic")[(s.104)].]
